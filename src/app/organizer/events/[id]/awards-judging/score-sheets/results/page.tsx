...
export default async function ScoreSheetResultsPage({ params }: Props) {
  ...
  await requireStaffStepUpPage({
    user,
    pathname: `/organizer/events/${eventId}/awards-judging/score-sheets/results`,
  });
    ...
    <div className="mx-auto max-w-5xl space-y-6 px-4 py-8">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">
          Ranked vehicles by average judge score per judging class
        </p>
      </div>
