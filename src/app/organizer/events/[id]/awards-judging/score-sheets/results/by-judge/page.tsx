...
import { OrganizerJudgeScoreSheetMatrix } from "@/components/organizer/awards-judging/organizer-judge-score-sheet-matrix";
...
export default async function ScoreSheetByJudgePage({ params }: Props) {
  ...
  await requireStaffStepUpPage({
    user,
    pathname: `/organizer/events/${eventId}/awards-judging/score-sheets/results/by-judge`,
  });
    ...
    <div className="mx-auto max-w-7xl space-y-6 px-4 py-8">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">
          Compare one judge&apos;s subcategory deductions across their vehicles
        </p>
      </div>
      ...
      <OrganizerJudgeScoreSheetMatrix eventId={eventId} />
